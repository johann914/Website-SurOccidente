...
<fieldset class="collapsible form-wrapper collapsed">
	...
	<table class="pure-table">
		...
		<tr>
		    ...
		    <th>
			<?php print $view->field['field_planeacion_descripcion']->options['label']; ?>
		    </th>
		    <th>
			<?php print $view->field['field_planeacion_periodicidad']->options['label']; ?>
		    </th>
		    <th>
			<?php print '&nbsp;'.$view->field['field_planeacion_tipo_de_recurso']->options['label']; ?>
		    </th>
		</tr>
	    </thead>
	    <tbody>
