...
<div id="nodo-contenido-marco-legal">
    <div class="pure-g">
	    ...
	    <p><?php print format_date(strtotime($node->field_planeacion_fecha_expe['und'][0]['value']), 'custom', 'F Y');?> </p>
	    <?php if (!empty($node->field_planeacion_fecha_expe['und'][0]['value2'])): ?>
	    	<p> <?php print format_date(strtotime($node->field_planeacion_fecha_expe['und'][0]['value2']), 'custom', 'F Y');?> </p>
	    <?php endif; ?>
	</div>
      	<div class="pure-u-1-1">
	    <?php print render($content['field_planeacion_descripcion']); ?>
      	</div>
    </div>
    <div class="pure-g">
	...
	<div class="pure-u-1-2 lanzadera">
		...
		<?php print render($content['field_archivo_adjunto_planeacion']); ?>
	    <?php endif; ?>
    	</div>
    </div>
</div>
